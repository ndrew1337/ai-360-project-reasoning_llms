# tot/methods/mcts.py
# MCTS implementation that keeps LLM helpers максимально похожими на bfs.py
# (same propose/value/vote/sample wrappers; MCTS-only logic on top)
...
# -----------------------
# BFS-like helpers (same style as bfs.py)
# -----------------------
...
def solve(args, task, idx, to_print=True):
    """
    MCTS over trajectories; LLM interaction максимально близко к bfs.py.
